...
{
    public class ProcesoA3 : ProcesoBase
    {
        public ProcesoA3(string nombreFichero, List<String> log, IOrganizationService servicio, XmlDocument xDoc, GestionSolicitudesATR gestor, Operaciones operaciones)
            : base(nombreFichero, log, servicio, xDoc, gestor, operaciones)
        {
        }

        public ProcesoA3(string proceso, string paso, ParametrosATR parametrosATR, ITracingService tracingService, string nombreXml, Entity datos01, Operaciones operaciones, AtosXml atosXml)
