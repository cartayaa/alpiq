...
namespace TermPricing
{
    ...
    public class Formula : FormulaBase
    {
        ...
        /*static public Formula creaFormula(Entity _tipoProducto, ITracingService tracingService, bool tipoCalculoPromedio,
                                          bool _log, String ficherolog, Boolean _facturacionEstimada = false)
        {
            if (_tipoProducto.Attributes.Contains("atos_formula") == false)
                return null;
            if (_tipoProducto.Attributes["atos_formula"].ToString() == "")
        ...
        public List<FormulaBase> construyeFormulas(Entity _tipoProducto, IOrganizationService OrganizationService,
