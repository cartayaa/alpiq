...
namespace TermPricing
{
    ...
    public class TermPricing : Componente
    {
        ...
        public TermPricing(TermPricing _termpricing) : base(_termpricing.NombreComponente, _termpricing.tipo)
        {
        ...
        public bool buscaTerminoPricing(IOrganizationService _service)
        {
            ...
            /* 1308-202 -1 */ // Log.writelog("buscaTerminoPricing 1");
            ...
            {
                /* 1308-202 -1 */ // Log.writelog("buscaTerminoPricing encontrado: " + base.nombre);
                ...
                if (_resConsulta.Entities[0].Attributes.Contains("atos_tipo"))
                {
                    ...
                    /* 1308-202 -1 */ // Log.writelog("buscaTerminoPricing " + base.nombre + " Tipo: " + fijoindexado.Value.ToString());
                }
                if (_resConsulta.Entities[0].Attributes.Contains("atos_terminopricingdinamicoid"))
                {
                    ...
                    /* 1308-202 -1 */ // Log.writelog("buscaTerminoPricing " + base.nombre + " Termino Pricing Dinamico " + ((EntityReference)_resConsulta.Entities[0].Attributes["atos_terminopricingdinamicoid"]).Name);
                }
                _ret = true;
            }
        ...
        public void calcula(Entity _tarifa, Entity _pricinginput)
        {
            ...
            // Si el tipo no es Fijo no se calcula precio.
