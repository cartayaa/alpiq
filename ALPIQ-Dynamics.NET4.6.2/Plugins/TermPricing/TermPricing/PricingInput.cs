...
namespace TermPricing
{
    class PricingInput
    {
        ...
        public EntityCollection coleccion(ref List<Componente> componentes, int i, Entity _oferta, Entity _ofpre, bool _ofertaid = false)
        {
            ...
            /* 1208-2022 -1 */ // Log.writelog("1 pricingInputCollection " + _fechaInicioOferta.ToLocalTime().ToShortDateString() + " - " + _fechaFinOferta.ToLocalTime().ToShortDateString(), _traza);
            ...
            if (facturacionEstimada && _ofertaid == true) 
            {
                ...
                _filtro.Conditions.Add(_condicion);
                /* 1208-2022 -1 */ // Log.writelog("3.1 pricingInputCollection Facturacion Estimada true ");
            }
            else
            {
                _condicion = new ConditionExpression();
                ...
                _filtro.Conditions.Add(_condicion);
                /* 1208-2022 -1 */ // Log.writelog("3.2 pricingInputCollection Facturacion Estimada no true ");
            }
            ...
            {
                /* 1208-2022 -1 */ // Log.writelog("4.0 pricingInputCollection. Depende de Tarifa");
                _condicion.Operator = ConditionOperator.Equal;
                if (_oferta.Attributes.Contains("atos_tarifaid"))
            ...
            {
                /* 1208-2022 -1 */ // Log.writelog("5.0 pricingInputCollection. Depende de Sistema Eléctrico");
                _condicion.Operator = ConditionOperator.Equal;
                if (_oferta.Attributes.Contains("atos_sistemaelectricoid"))
            ...
            {
                /* 1208-2022 -1 */ // Log.writelog("5.1 pricingInputCollection. Depende de Subsistema Eléctrico");
                _condicion.Operator = ConditionOperator.Equal;
                if (_oferta.Attributes.Contains("atos_subsistemaid"))
            ...
            /* 1208-2022 -1 */ // Log.writelog("5.1 pricingInputCollection");
            _filtro.Conditions.Add(_condicion);
            ...
            {
                /* 1208-2022 -1 */ // Log.writelog("5.1 atos_peajeid. Depende de Peaje");
                _condicion.Operator = ConditionOperator.Equal;
                if (_oferta.Attributes.Contains("atos_peajeid"))
                {
                    _condicion.Values.Add(((EntityReference)_oferta.Attributes["atos_peajeid"]).Id.ToString());
                    /* 1208-2022 -1 */ // Log.writelog("5.1.1 atos_peajeid. " + ((EntityReference)_oferta.Attributes["atos_peajeid"]).Id.ToString());
                }
                else
                {
                    _condicion.Values.Add(((EntityReference)_ofpre.Attributes["atos_peajeid"]).Id.ToString());
                    /* 1208-2022 -1 */ // Log.writelog("5.1.2 atos_peajeid. " + ((EntityReference)_ofpre.Attributes["atos_peajeid"]).Id.ToString());
                }
            }
            else
            {
            ...
            /* 1208-2022 -1 */ // Log.writelog("5.2 atos_peajeid");
            _filtro.Conditions.Add(_condicion);

            DateTime Ahora = DateTime.Now;
            DateTime utcNow = DateTime.UtcNow;
            //DateTime NowLocal = DateTimeSpan.DateTimeLocal(utcNow, _service);
            /* 1208-2022 -1 */ // Log.writelog("6 pricingInputCollection. atos_fechainiciovigencia <= " + Ahora.ToLongDateString() + " " + Ahora.ToLongTimeString(), _traza);
            ...
            /* 1208-2022 -1 */ // Log.writelog("6.1 pricingInputCollection. UtcNow: " + utcNow.ToLongDateString() + " " + utcNow.ToLongTimeString(), _traza);
            //Log.writelog("6.2 pricingInputCollection. NowLocal: " + NowLocal.ToLongDateString() + " " + NowLocal.ToLongTimeString(), true);

            /* 1208-2022 -1 */ // Log.writelog("7 pricingInputCollection. atos_fechafinvigencia >= " + Ahora.ToLongDateString() + " " + Ahora.ToLongTimeString(), _traza);
            _condicion = new ConditionExpression();
            ...
            /* 1208-2022 -1 */ // Log.writelog("16 pricingInputCollection: " + _resultado.Entities.Count.ToString() , _traza);

            // codigo comentado en el fuente original
