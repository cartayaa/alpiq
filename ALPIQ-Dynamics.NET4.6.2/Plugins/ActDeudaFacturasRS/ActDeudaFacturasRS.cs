...
namespace ActDeudaFacturasRS
{
    public class ActDeudaFacturasRS:IPlugin
    {
        ...
        private const int ESTADO_DEUDA_RECTIFICADA = 300000008;
        private const int ESTADO_DEUDA_PENDIENTE_PAGO = 1;
		...
		// </remarks>
         */
        public ActDeudaFacturasRS(String parametros)
        {
        ...
        */
        public void Execute(IServiceProvider serviceProvider)
        {
            ...
            {
                ef = (Entity)PluginExecutionContext.PostEntityImages["FacturaImageRS"];
                Entity target = (Entity)PluginExecutionContext.InputParameters["Target"];
                Entity preImage = (Entity)PluginExecutionContext.PreEntityImages["FacturaImageRS"];
            ...
            {
                ef = (Entity)PluginExecutionContext.PreEntityImages["PreDeleteImageRS"];
                actualizarTotalFacturas = true;
                actualizarImporteDeuda = true;
            }
                        ...
                        Filters = 
                            {
                                new FilterExpression
                                {
                                    ...
                                    {
                                        new ConditionExpression(pNombreCampoBusqueda, ConditionOperator.Equal, pId),
                                        new ConditionExpression("statuscode", ConditionOperator.NotEqual , ESTADO_DEUDA_RECTIFICADA),
                                    },
                                }
