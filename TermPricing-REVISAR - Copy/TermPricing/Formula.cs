 ...
 * Andres Cartaya   1208-2022   Comentarios de algunos Traces.Log
 *                              
 */
using System;
...
namespace TermPricing
{
    ...
    {
        /* 01208-2022 +3 */
        // Tipos de Termino de Pricing
        const int FIJO = 300000000;
        const int INDEXADO = 300000001;
        ...
        {
            get { return this.precisiondecimales; }
            set { this.precisiondecimales = value; }
        }

        public int PrecisionDecimalesTerminos
        {
            get { return this.precisiondecimalesterminos; }
            set { this.precisiondecimalesterminos = value; }
        }

        // Pricing Gas
        public Boolean esInstalacionGas
        {
            get { return this.esGas; }
            set { this.esGas = value; }
        }
        // Fin Pricing Gas

        public String TipoFormula { get { return this.tipo; } }

        public String NombreFormula { get { return this.nombre; } }

        public String ExpresionFormula  { get { return this.expresion; } }

        public String ExpresionFinalFormula { get { return this.expresionfinal; } }

        public List<Componente> ComponentesFormula { get { return this.componentes; } }

        public OptionSetValue FijoOIndexado { get { return this.fijoindexado; } }
        ...
        */
        ...
        public void calculaTermPricing(int _termPricing, Entity _tarifa, Entity _pricinginput)
        {
            if (((TermPricing)componentes[_termPricing]).FijoIndexado == null)
                Log.writelog("Formula: " + nombre + " calculaTermPricing: " + ((TermPricing)componentes[_termPricing]).NombreComponente + " Fijo Indexado a null");
    ...
    public class Formula : FormulaBase
    {
                            ...
                            Entity _oferta, Entity _ofpre, bool _ofertaid = false) //, Entity _tipoProducto, Entity _tarifa)
        {
            ...
            /* 1208-2022 +1 */ // base.Log.writelog("1 pricingInput");
            QueryExpression _consulta = new QueryExpression("atos_pricinginput");
            _consulta.NoLock = true; /* 1208-2022 +1 */
            /* 1208-2022 +1 */ // base.Log.writelog("2 pricingInput");
            ...
            /* 1208-2022 +1 */ // base.Log.writelog("3 pricingInput " + ((TermPricing)componentes[i]).TermpricingId.ToString());
            ...
            if (((TermPricing)componentes[i]).DependeDeTarifa == true)
            {
                ...
                /* 1208-2022 +1 */ // base.Log.writelog("4 pricingInput");
                _filtro.Conditions.Add(_condicion);
            }
            ...
            if (((TermPricing)componentes[i]).DependeDeSistemaElectrico == true)
            {
                ...
                /* 1208-2022 +1 */ // base.Log.writelog("5 pricingInput");
                _filtro.Conditions.Add(_condicion);
            }

            /* 1208-2022 +1 */ // base.Log.writelog("6 pricingInput");
            _condicion = new ConditionExpression();
            ...
            /* 1208-2022 +1 */ // base.Log.writelog("7 pricingInput");
            _condicion = new ConditionExpression();
            ...
            if (_ofertaid == true)
            {
                /* 1208-2022 +1 */ // base.Log.writelog("9 pricingInput " + _ofpre.Id.ToString());
                _condicion = new ConditionExpression();
            ...
            {
                /* 1208-2022 +1 */ // base.Log.writelog("10 pricingInput");
                _condicion = new ConditionExpression();
                _condicion.AttributeName = "atos_ofertaid";
                _condicion.Operator = ConditionOperator.Null;
                _filtro.Conditions.Add(_condicion);

                /* 1208-2022 +1 */ // base.Log.writelog("11 pricingInput");
                _condicion = new ConditionExpression();
                ...
                /* 1208-2022 +1 */ // base.Log.writelog("12 pricingInput");
                _condicion = new ConditionExpression();
                ...
                _filtro.Conditions.Add(_condicion);
                /* 1208-2022 +1 */ // base.Log.writelog("13 pricingInput");
                            ...
                            Entity _oferta, Entity _ofpre, bool _ofertaid = false) //, Entity _tipoProducto, Entity _tarifa)
        {
            ...
            /* 1208-2022 +1 */ // Log.writelog("1 pricingInputCollection " + _fechaInicioOferta.ToLocalTime().ToShortDateString() + " - " + _fechaFinOferta.ToLocalTime().ToShortDateString());
            QueryExpression _consulta = new QueryExpression("atos_pricinginput");
            /* 1208-2022 +1 */
            _consulta.NoLock = true;
            /* 1208-2022 +1 */ // Log.writelog("2 pricingInputCollection");
            FilterExpression _filtro = new FilterExpression();
            _filtro.FilterOperator = LogicalOperator.And;
            ConditionExpression _condicion = new ConditionExpression();
            _condicion.AttributeName = "atos_terminodepricingid";
            ...
            _condicion.Values.Add(((TermPricing)componentes[i]).TermpricingId.ToString());
            _filtro.Conditions.Add(_condicion);
            /* 1208-2022 +1 */ // Log.writelog("3 pricingInputCollection " + ((TermPricing)componentes[i]).TermpricingId.ToString());
            ...
            /* 1208-2022 +1 */ // Log.writelog("4 pricingInputCollection");
            _filtro.Conditions.Add(_condicion);
            ...
            /* 1208-2022 +1 */ // Log.writelog("5 pricingInputCollection");
            _filtro.Conditions.Add(_condicion);

            /* 1208-2022 +1 */ // Log.writelog("6 pricingInputCollection");
            _condicion = new ConditionExpression();
            _condicion.AttributeName = "atos_fechainiciovigencia";
            _condicion.Operator = ConditionOperator.LessEqual;
            _condicion.Values.Add(DateTime.Now);
            ...
            /* 1208-2022 +1 */ // Log.writelog("7 pricingInputCollection");
            _condicion = new ConditionExpression();
            _condicion.AttributeName = "atos_fechafinvigencia";
            _condicion.Operator = ConditionOperator.GreaterEqual;
            _condicion.Values.Add(DateTime.Now);
            ...
            if (_ofertaid == true)
            {
                /* 1208-2022 +1 */ // Log.writelog("9 pricingInputCollection " + _ofpre.Id.ToString());
                _condicion = new ConditionExpression();
                _condicion.AttributeName = "atos_ofertaid";
                _condicion.Operator = ConditionOperator.Equal;
                _condicion.Values.Add(_ofpre.Id.ToString());
            ...
            {
                /* 1208-2022 +1 */ // Log.writelog("10 pricingInputCollection");
                _condicion = new ConditionExpression();
                _condicion.AttributeName = "atos_ofertaid";
                _condicion.Operator = ConditionOperator.Null;
                _filtro.Conditions.Add(_condicion);

                /* 1208-2022 +1 */ // Log.writelog("11 pricingInputCollection");
                _condicion = new ConditionExpression();
                _condicion.AttributeName = "atos_fechainicioaplicacion";
                _condicion.Operator = ConditionOperator.LessEqual;
                ...
                /* 1208-2022 +1 */ // Log.writelog("12 pricingInputCollection");
                _condicion = new ConditionExpression();
                _condicion.AttributeName = "atos_fechafinaplicacion";
                _condicion.Operator = ConditionOperator.GreaterEqual;
                ...
                /*if (_oferta.Attributes.Contains("atos_fechainicio"))
                    ...
                    _condicion.Values.Add(_ofpre.Attributes["atos_fechainicio"]);*/
                _filtro.Conditions.Add(_condicion);
                /* 1208-2022 +1 */ // Log.writelog("13 pricingInputCollection");
            ...
            /* 1208-2022 +1 */ // Log.writelog("14 pricingInputCollection");
            ...
            /* 1208-2022 +1 */ // Log.writelog("15 pricingInputCollection");
            EntityCollection _resultado = _service.RetrieveMultiple(_consulta);

            /* 1208-2022 +1 */ // Log.writelog("16 pricingInputCollection");
            ...
            /* 1208-2022 +1 */ // Log.writelog("17 pricingInput");
                            ...
                            Entity _oferta, Entity _ofpre, Entity _tipoProducto, Entity _tarifa, ref List<String> _errores)
        {
            ...
            for (int i = 0; i < componentes.Count; i++)
            {
                if (componentes[i].TipoComponente == "TermPricing")
                {
                    try
                    {
                        ...
                        if (((TermPricing)componentes[i]).FijoIndexado.Value == 300000000) // FIJO
                        {
                    ...
                    if (componentes[j].TipoComponente == "Variable" && componentes[j].NombreComponente == _variables[i].NombreFormula)
                    {
                        try
                        {
                            ...
                            if (((Variable)_variables[i]).calcula(ref componentes, ref _variables, j, _service, _tipoProducto, _tarifa, ref _errores) == true)
                            {
                                ...
                                // Solo se puede calcular si todos los términos son fijos (no indexados)
                                if (((Variable)_variables[i]).FijoOIndexado.Value == 300000000) // FIJO
                                {
            ...
            if (_calculosintermedios == true)
            {
                ...
                // Solo se puede calcular si todos los términos de la fórmula son de tipo fijo
                if (fijoindexado.Value == 300000000) // FIJO
                {
                    if (periodo == 0)
                    {
                            ...
                            Entity _oferta, Entity _ofpre, Entity _tipoProducto, Entity _tarifa, ref List<String> _errores)
        {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            for (int j = 0; j < ((TermPricing)componentes[i]).NumeroPricingInputs; j++)
                            {
                                ...
                                // Si es fijo se calcula el valor
                                if (((TermPricing)componentes[i]).FijoIndexado.Value == 300000000) // FIJO
                                {
                                    for (int k = 1; k <= periodo; k++)
                                    {
            ...
            while (fini < fechafin ) // Chequeamos contra la fecha de inicio para tratar el último tramo cuando la duración no es un número entero.
            {
                ...
                fijoindexado = new OptionSetValue(300000000); // FIJO
                    ...
                    if (componentes[i].TipoComponente == "TermPricing")
                    {
                        try
                        {
                            ...
                            */
                            ...
                            // Si es fijo se calculan los valores
                            if (((TermPricing)componentes[i]).FijoIndexado.Value == 300000000) // FIJO
                            {
            ...
            for (int i = 0; i < _componentes.Count; i++)
            {
                if (_componentes[i].TipoComponente == "TermPricing")
                {
                    ...
                    if (((TermPricing)_componentes[i]).FijoIndexado.Value == 300000000) // Solo se calcula si es de tipo fijo
                    {
                        ...
                        // Log.writelog("PricingInput tiene " + _valorPricingInput.NumeroPeriodos.ToString() + " periodos");
                        // No hay que prorratear nunca los importes
                        ...
                        Log.writelog(_componentes[i].NombreComponente + "=<" + _valorPricingInput.Valores[_p].ToString() + ">");
