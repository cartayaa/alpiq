...
namespace CommonWS
{
    public class Log
    {
        ...
        {
            get { return this.escribirLog; }
        }

        public String UriWSLog
        {
            get { return this.uriWSLog; }
        }

        public String SubCarpetaLog
        {
            get { return this.subCarpetaLog; }
        }

        public String FicheroLog
        {
            get { return this.ficheroLog; }
        }
        
        public ITracingService tracingService
        {
            get { return this.TracingService; }
        ...
        public void writelog(String texto, bool _traza = true)
        {
            try
            {
                traza(texto, _traza);
            ...
            {
                writelog("Exception:" + ex.Message, true);
            }
        }
